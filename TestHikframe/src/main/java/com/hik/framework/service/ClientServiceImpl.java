...
public class ClientServiceImpl  extends BaseService implements ClientService{
    ...
    private final Log log = LogFactory.getLog(ClientServiceImpl.class);
...
//		clientDao.insertClient(fileName, "android", version, versiondesc, versionName, serverhttp+"resource/client/android/"+fileName, userid);
		clientDao.insertClient(fileName, "android", version, versiondesc, versionName, "resource/client/android/"+fileName, userid);
