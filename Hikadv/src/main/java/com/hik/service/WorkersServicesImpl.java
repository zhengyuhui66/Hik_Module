...
@Service
public class WorkersServicesImpl  extends BaseService  implements WorkersServices{
	...
	@Autowired
	private WorJPASqlDao worJPASqlDao2;
	
	@Autowired
	private WorkersServices2 WorkersServices;
...
//		int list = worJPASqlDao.update2();
		WorkersServices.tupdateid2();
//		try{
		WorkersServices.tupdateid();
