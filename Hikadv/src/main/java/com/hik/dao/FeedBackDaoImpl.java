...
@Repository
public class FeedBackDaoImpl extends BaseHIKDao implements FeedBackDao{

	@Override
	public Page queryClientInfo(int start,int limit) {
		// TODO Auto-generated method stub
		String sql="select id,clienttype,contents,contract,scorts,attachmentpath,nettype,system,creator,creatime from feedback";
		String[] str = new String[]{"id","clienttype","contents","contract","scorts","attachmentpath","nettype","system","creator","creatime"};
