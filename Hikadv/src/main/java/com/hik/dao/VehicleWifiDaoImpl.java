...
@Deprecated
@Repository
public class VehicleWifiDaoImpl extends BaseHIKDao implements VehicleWifiDao{
...
//		
//		
//		String[] strs= new String[]{"timeid","addressid","eventid","phone","advid"};
//		return getNoPageObject(sql, params, strs,"取出符合优先条件的条件信息");
//	}
//	
//	public List<JSONObject> queryPriByTime(List<String> advid, String timeid){
//		// TODO Auto-generated method stub
//		List params = new ArrayList();
//		String sql="";
//		for(int i=0;i<advid.size();i++){
//			String tempadvid=advid.get(i).toString();
//			params.add(tempadvid);
//			sql="SELECT t.timeid,ts.id,P.TIMEID, P.ADDREDSSID, P.EVENTID, P.PHONE, '"+tempadvid+"' AS ADVID "+
//			  "FROM PRICONDITION P "+
//			  "LEFT JOIN TIMERELATION T "+
//			    "ON (P.TIMEID = T.GROUPID) "+
//			  "LEFT JOIN TIMESIGN TS "+
//			    "ON (T.TIMEID = TS.ID) "+
//			 "WHERE P.ID IN "+
//			       "(SELECT PRICONDITIONID FROM ADV_PRICONDITION WHERE ADVID = '341') "+
//			        "AND (ts.STIME || ' ' || ts.SDTIME) < '2016-12-12 13:52:03' "+
//			        "AND (ts.ETIME || ' ' || ts.EDTIME) > '2016-12-12 13:52:03' ";
//			if(i<advid.size()-1){
//				sql+=" union ";				
//			}
//		}
