...
var internetUserGrid=Ext.define('Ext.internetUserGrid.TreeGrid', {
...
//    	});
    	...
    	Ext.define('corMangerModel', {
    	    extend: 'Ext.data.Model',
    	    fields:["id","mac","phone","authtime","equipmentid","apmac","busid","code","routeid","routename","creator","modifier","createtime","modifytime","mark"]
...
//        });
   	 ...
   	 var trStore=Ext.create('Ext.data.Store', {
   		    ...
   		    proxy: {
   		    	type: 'ajax',
   		    	url:rootUrl+'/internetusercontroller/queryinternetuser',//'/deviceofflinecontroller/queryofflinemanger',
   		        reader: {
   		            type: 'json',
   		            root: 'elementList',  
   		            totalProperty: 'total'
